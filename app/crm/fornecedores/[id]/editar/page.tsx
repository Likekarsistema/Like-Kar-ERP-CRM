...
import { getMockSupplierById, updateMockSupplier } from "@/lib/mock-data"
...
export default function EditarFornecedorPage() {
  ...
  useEffect(() => {
    const loadSupplier = async () => {
      try {
        const supplier = getMockSupplierById(supplierId)
        if (supplier) {
          setFormData({
            name: supplier.name || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateMockSupplier(supplierId, {
        ...formData,
      ...
      router.push(`/crm/fornecedores/${supplierId}`)
    } catch (error: any) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500">Atualize as informações do fornecedor</p>
          </div>
        </div>
      </div>
              ...
              <CardContent className="pt-6">
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full"
                    onClick={() => router.push(`/crm/fornecedores`)}
                    disabled={loading}
                  >
                    Cancelar
                  </Button>
