...
export function RecentLeads({ leads = [], inDevelopment = false }: RecentLeadsProps) {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-800">Leads Recentes</h3>
        <a href="/erp/leads" className="text-yellow-600 hover:text-yellow-700 text-sm font-medium">
          Ver todos
        </a>
      </div>
      ...
      {leads.length === 0 ? (
        <div className="text-center py-8">
          ...
          <a href="/erp/leads" className="text-yellow-600 hover:text-yellow-700 text-sm font-medium mt-2 inline-block">
