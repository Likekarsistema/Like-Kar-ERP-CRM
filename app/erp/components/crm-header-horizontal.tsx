...
export function CrmHeaderHorizontal({ user }: CrmHeaderHorizontalProps) {
  ...
  const cadastrosItems = [
    { label: "Produtos", href: "/erp/produtos", icon: Package },
    { label: "Serviços", href: "/erp/servicos", icon: FileText },
    { label: "Categorias de Produtos", href: "/erp/categorias", icon: Tag },
    { label: "Clientes", href: "/erp/clientes", icon: Users },
    { label: "Fornecedores", href: "/erp/fornecedores", icon: Truck },
    { label: "Colaboradores", href: "/erp/colaboradores", icon: User },
  ]

  const vendasItems = [
    { label: "Orçamentos", href: "/erp/orcamentos", icon: FileText },
    { label: "Vendas", href: "/erp/vendas", icon: DollarSign },
  ]

  const comprasItems = [
    { label: "Pedidos de Compra", href: "/erp/pedidos-compra", icon: ShoppingCart },
    { label: "Fornecedores", href: "/erp/fornecedores", icon: Truck },
  ]

  const estoqueItems = [
    { label: "Produtos", href: "/erp/produtos", icon: Package },
    { label: "Movimentações", href: "/erp/movimentacoes", icon: FileText },
  ]

  const financeiroItems = [
    { label: "Contas a Receber", href: "/erp/contas-receber", icon: DollarSign },
    { label: "Contas a Pagar", href: "/erp/contas-pagar", icon: CreditCard },
    { label: "Fluxo de Caixa", href: "/erp/fluxo-caixa", icon: FileText },
  ]
    ...
    <header className="bg-white border-b border-gray-200 px-6 py-4 relative z-50">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-8">
          {/* Logo */}
          <Link href="/erp/dashboard" className="flex items-center" onClick={closeAllDropdowns}>
