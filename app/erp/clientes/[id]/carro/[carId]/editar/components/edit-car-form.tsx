...
import { getCarFromCustomer, updateCarInCustomer } from "@/lib/mock-data"
...
export function EditCarForm({ customerId, carId }: EditCarFormProps) {
  ...
  useEffect(() => {
    ...
    const car = getCarFromCustomer(customerId, carId)
    if (car) {
      setFormData({
        vehicle_type: car.vehicle_type || "carro",
        brand: car.brand || "",
        model: car.model || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Atualizar carro nos dados mock
      const carData = {
      ...
      updateCarInCustomer(customerId, carId, carData)
