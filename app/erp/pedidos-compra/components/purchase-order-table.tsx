          ...
          <TableBody>
            {purchaseOrders.map((order) => (
              <TableRow key={order.id} className="hover:bg-gray-50">
                ...
                <TableCell>
                  <div>
                    <Link href={`/erp/pedidos-compra/${order.id}`} className="font-medium text-gray-900 cursor-pointer">
                      {order.supplier}
                    </Link>
                ...
                <TableCell>
                  <Link href={`/erp/pedidos-compra/${order.id}`} className="text-blue-600 hover:text-blue-800">
                    {order.number}
                  </Link>
                </TableCell>
                <TableCell>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem asChild>
                        <Link href={`/erp/pedidos-compra/${order.id}`}>
                          <Eye size={16} className="mr-2" />
                          Ver Detalhes
                        </Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem asChild>
                        <Link href={`/erp/pedidos-compra/${order.id}/editar`}>
