            ...
            {suppliers.map((supplier) => (
              <TableRow key={supplier.id} className="hover:bg-gray-50">
                ...
                <TableCell>
                  <div>
                    <Link
                      href={`/erp/fornecedores/${supplier.id}`}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem asChild>
                        <Link href={`/erp/fornecedores/${supplier.id}`}>
                          <Eye size={16} className="mr-2" />
                          Ver Detalhes
                        </Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem asChild>
                        <Link href={`/erp/fornecedores/${supplier.id}/editar`}>
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3 flex-1">
                ...
                <div className="flex-1">
                  <Link href={`/erp/fornecedores/${supplier.id}`} className="font-medium text-gray-900 cursor-pointer">
                    <h3>{supplier.name}</h3>
                  </Link>
                  {supplier.contact_person && (
